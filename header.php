...
?>
<script src="https://<?=$_SERVER['HTTP_HOST']?>/functions.js"></script>
<html>
    <head>
    <meta charset="utf-8">
    <!-- Настройка viewport -->
    ...
    <!-- Подключаем Bootstrap CSS -->
     ...
     > 
     <link rel="stylesheet" href="https://<?=$_SERVER["SERVER_NAME"]?>:<?=$_SERVER['SERVER_PORT']?>/style.css">
            ...
            <header id='header-lg'> 
                ...
                <div class='col-sm-3'>
                    ...
                    <span class='container__enter' id='enter'> 
                        <img src=<?php echo 'https://'.$_SERVER['HTTP_HOST'] ."\img\icons\account.png"?>>  
                        <?php
                    ...
                    <span class='container__basket'>
                        <img src=<?php echo 'https://'.$_SERVER['HTTP_HOST'] ."\img\icons\bascet.png"?>> 
